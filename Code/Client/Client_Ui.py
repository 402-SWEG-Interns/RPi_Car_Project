...
"")
        # ----- Experimental UI ----- #
        self.Btn_O1st = QtWidgets.QPushButton(Client)
        self.Btn_O1st.setGeometry(QtCore.QRect(10, 350, 70, 25)) # Full width will be 90, but 70 goes to the color-change button; applies to rest of buttons
        font = QtGui.QFont()
        font.setFamily("Malgun Gothic")
        font.setPointSize(9)
        self.Btn_O1st.setFont(font)
        # self.Btn_O1st.setStyleSheet("")
        self.Btn_O1st.setObjectName("Btn_O1st")
        self.Lbl_O1st = QtWidgets.QLabel(Client)
        self.Lbl_O1st.setGeometry(QtCore.QRect(80, 350, 20, 25))
        font = QtGui.QFont()
        font.setFamily("Malgun Gothic")
        font.setPointSize(9)
        self.Lbl_O1st.setFont(font)
        # self.Lbl_O1st.setStyleSheet("")
        self.Lbl_O1st.setObjectName("Lbl_O1st")

        self.Btn_O2nd = QtWidgets.QPushButton(Client)
        self.Btn_O2nd.setGeometry(QtCore.QRect(110, 350, 70, 25))
        font = QtGui.QFont()
        font.setFamily("Malgun Gothic")
        font.setPointSize(9)
        self.Btn_O2nd.setFont(font)
        # self.Btn_O2nd.setStyleSheet("")
        self.Btn_O2nd.setObjectName("Btn_O2nd")
        self.Lbl_O2nd = QtWidgets.QLabel(Client)
        self.Lbl_O2nd.setGeometry(QtCore.QRect(180, 350, 20, 25))
        font = QtGui.QFont()
        font.setFamily("Malgun Gothic")
        font.setPointSize(9)
        self.Lbl_O2nd.setFont(font)
        # self.Lbl_O2nd.setStyleSheet("")
        self.Lbl_O2nd.setObjectName("Lbl_O2nd")

        self.Btn_O3rd = QtWidgets.QPushButton(Client)
        self.Btn_O3rd.setGeometry(QtCore.QRect(210, 350, 70, 25))
        font = QtGui.QFont()
        font.setFamily("Malgun Gothic")
        font.setPointSize(9)
        self.Btn_O3rd.setFont(font)
        # self.Btn_O3rd.setStyleSheet("")
        self.Btn_O3rd.setObjectName("Btn_O3rd")
        self.Lbl_O3rd = QtWidgets.QLabel(Client)
        self.Lbl_O3rd.setGeometry(QtCore.QRect(280, 350, 20, 25))
        font = QtGui.QFont()
        font.setFamily("Malgun Gothic")
        font.setPointSize(9)
        self.Lbl_O3rd.setFont(font)
        # self.Lbl_O3rd.setStyleSheet("")
        self.Lbl_O3rd.setObjectName("Lbl_O3rd")

        """self.Btn_O4th = QtWidgets.QPushButton(Client)
        self.Btn_O4th.setGeometry(QtCore.QRect(310, 350, 70, 25))
        font = QtGui.QFont()
        font.setFamily("Malgun Gothic")
        font.setPointSize(9)
        self.Btn_O4th.setFont(font)
        # self.Btn_O4th.setStyleSheet("")
        self.Btn_O4th.setObjectName("Btn_O4th")
        self.Lbl_O4th = QtWidgets.QLabel(Client)
        self.Lbl_O4th.setGeometry(QtCore.QRect(380, 350, 20, 25))
        font = QtGui.QFont()
        font.setFamily("Malgun Gothic")
        font.setPointSize(9)
        self.Lbl_O4th.setFont(font)
        # self.Lbl_O4th.setStyleSheet("")
        self.Lbl_O4th.setObjectName("Lbl_O4th")"""
        # ----- Experimental UI ----- #
...
"")
    ...
    def retranslateUi(self, Client):
        ...
        # ----- Experimental UI ----- #
        self.Btn_O1st.setText(_translate("Client", "none"))
        self.Lbl_O1st.setText(_translate("Client", "1"))

        self.Btn_O2nd.setText(_translate("Client", "none"))
        self.Lbl_O2nd.setText(_translate("Client", "2"))

        self.Btn_O3rd.setText(_translate("Client", "none"))
        self.Lbl_O3rd.setText(_translate("Client", "3"))

        """self.Btn_O4th.setText(_translate("Client", "none"))
        self.Lbl_O4th.setText(_translate("Client", "4"))"""
        # ----- Experimental UI ----- #
