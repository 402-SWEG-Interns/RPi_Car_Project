...
"")
        # ----- Experimental UI ----- #
        self.Btn_C1st = QtWidgets.QPushButton(Client)
        self.Btn_C1st.setGeometry(QtCore.QRect(10, 350, 70, 20)) # Full width will be 90, but 70 goes to the color-change button; applies to rest of buttons
        font = QtGui.QFont()
        font.setFamily("Malgun Gothic")
        font.setPointSize(9)
        self.Btn_C1st.setFont(font)
        # self.Btn_C1st.setStyleSheet("")
        self.Btn_C1st.setObjectName("Btn_C1st")
        self.Lbl_C1st = QtWidgets.QLabel(Client)
        self.Lbl_C1st.setGeometry(QtCore.QRect(80, 350, 20, 20))
        font = QtGui.QFont()
        font.setFamily("Malgun Gothic")
        font.setPointSize(9)
        self.Lbl_C1st.setFont(font)
        # self.Lbl_C1st.setStyleSheet("")
        self.Lbl_C1st.setObjectName("Lbl_C1st")

        self.Btn_C2nd = QtWidgets.QPushButton(Client)
        self.Btn_C2nd.setGeometry(QtCore.QRect(110, 350, 70, 20))
        font = QtGui.QFont()
        font.setFamily("Malgun Gothic")
        font.setPointSize(9)
        self.Btn_C2nd.setFont(font)
        # self.Btn_C2nd.setStyleSheet("")
        self.Btn_C2nd.setObjectName("Btn_C2nd")
        self.Lbl_C2nd = QtWidgets.QLabel(Client)
        self.Lbl_C2nd.setGeometry(QtCore.QRect(180, 350, 20, 20))
        font = QtGui.QFont()
        font.setFamily("Malgun Gothic")
        font.setPointSize(9)
        self.Lbl_C2nd.setFont(font)
        # self.Lbl_C2nd.setStyleSheet("")
        self.Lbl_C2nd.setObjectName("Lbl_C2nd")

        self.Btn_C3rd = QtWidgets.QPushButton(Client)
        self.Btn_C3rd.setGeometry(QtCore.QRect(210, 350, 70, 20))
        font = QtGui.QFont()
        font.setFamily("Malgun Gothic")
        font.setPointSize(9)
        self.Btn_C3rd.setFont(font)
        # self.Btn_C3rd.setStyleSheet("")
        self.Btn_C3rd.setObjectName("Btn_C3rd")
        self.Lbl_C3rd = QtWidgets.QLabel(Client)
        self.Lbl_C3rd.setGeometry(QtCore.QRect(280, 350, 20, 20))
        font = QtGui.QFont()
        font.setFamily("Malgun Gothic")
        font.setPointSize(9)
        self.Lbl_C3rd.setFont(font)
        # self.Lbl_C3rd.setStyleSheet("")
        self.Lbl_C3rd.setObjectName("Lbl_C3rd")

        self.Btn_C4th = QtWidgets.QPushButton(Client)
        self.Btn_C4th.setGeometry(QtCore.QRect(310, 350, 70, 20))
        font = QtGui.QFont()
        font.setFamily("Malgun Gothic")
        font.setPointSize(9)
        self.Btn_C4th.setFont(font)
        # self.Btn_C4th.setStyleSheet("")
        self.Btn_C4th.setObjectName("Btn_C4th")
        self.Lbl_C4th = QtWidgets.QLabel(Client)
        self.Lbl_C4th.setGeometry(QtCore.QRect(380, 350, 20, 20))
        font = QtGui.QFont()
        font.setFamily("Malgun Gothic")
        font.setPointSize(9)
        self.Lbl_C4th.setFont(font)
        # self.Lbl_C4th.setStyleSheet("")
        self.Lbl_C4th.setObjectName("Lbl_C4th")
        # ----- Experimental UI ----- #
...
"")
        ...
        self.Btn_Tracking_Objects = QtWidgets.QPushButton(Client)
        self.Btn_Tracking_Objects.setGeometry(QtCore.QRect(230, 460, 90, 30))
        font = QtGui.QFont()
        font.setFamily("Malgun Gothic")
        font.setPointSize(10)
        self.Btn_Tracking_Objects.setFont(font)
        self.Btn_Tracking_Objects.setStyleSheet("")
        self.Btn_Tracking_Objects.setObjectName("Btn_Tracking_Objects")
    ...
    def retranslateUi(self, Client):
        ...
        # ----- Experimental UI ----- #
        self.Btn_C1st.setText(_translate("Client", "none"))
        self.Lbl_C1st.setText(_translate("Client", "1"))

        self.Btn_C2nd.setText(_translate("Client", "none"))
        self.Lbl_C2nd.setText(_translate("Client", "2"))

        self.Btn_C3rd.setText(_translate("Client", "none"))
        self.Lbl_C3rd.setText(_translate("Client", "3"))

        self.Btn_C4th.setText(_translate("Client", "none"))
        self.Lbl_C4th.setText(_translate("Client", "4"))
        # ----- Experimental UI ----- #
        self.Btn_ForWard.setText(_translate("Client", "ForWard"))
        self.name.setText(_translate("Client", "Team SWEGY")) # Initially just 'Freenove'
        ...
        self.IP.setText(_translate("Client", "172.20.0.230")) # IP has been pre-typed here
        ...
        self.Btn_Tracking_Objects.setText(_translate("Client", "Tracing-On"))
