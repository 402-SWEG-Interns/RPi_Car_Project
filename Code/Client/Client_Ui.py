...
"")
        # ----- Experimental UI ----- #
        self.C1st = QtWidgets.QPushButton(Client)
        self.C1st.setGeometry(QtCore.QRect(10, 350, 70, 20)) # Full width will be 90, but 70 goes to the color-change button; applies to rest of buttons
        font = QtGui.QFont()
        font.setFamily("Malgun Gothic")
        font.setPointSize(9)
        self.C1st.setFont(font)
        # self.C1st.setStyleSheet("")
        self.C1st.setObjectName("C1st")
        self.C1st_Lbl = QtWidgets.QLabel(Client)
        self.C1st_Lbl.setGeometry(QtCore.QRect(80, 350, 20, 20))
        font = QtGui.QFont()
        font.setFamily("Malgun Gothic")
        font.setPointSize(9)
        self.C1st_Lbl.setFont(font)
        # self.C1st_Lbl.setStyleSheet("")
        self.C1st_Lbl.setObjectName("C1st_Lbl")

        self.C2nd = QtWidgets.QPushButton(Client)
        self.C2nd.setGeometry(QtCore.QRect(110, 350, 70, 20))
        font = QtGui.QFont()
        font.setFamily("Malgun Gothic")
        font.setPointSize(9)
        self.C2nd.setFont(font)
        # self.C2nd.setStyleSheet("")
        self.C2nd.setObjectName("C2nd")
        self.C2nd_Lbl = QtWidgets.QLabel(Client)
        self.C2nd_Lbl.setGeometry(QtCore.QRect(180, 350, 20, 20))
        font = QtGui.QFont()
        font.setFamily("Malgun Gothic")
        font.setPointSize(9)
        self.C2nd_Lbl.setFont(font)
        # self.C2nd_Lbl.setStyleSheet("")
        self.C2nd_Lbl.setObjectName("C2nd_Lbl")

        self.C3rd = QtWidgets.QPushButton(Client)
        self.C3rd.setGeometry(QtCore.QRect(210, 350, 70, 20))
        font = QtGui.QFont()
        font.setFamily("Malgun Gothic")
        font.setPointSize(9)
        self.C3rd.setFont(font)
        # self.C3rd.setStyleSheet("")
        self.C3rd.setObjectName("C3rd")
        self.C3rd_Lbl = QtWidgets.QLabel(Client)
        self.C3rd_Lbl.setGeometry(QtCore.QRect(280, 350, 20, 20))
        font = QtGui.QFont()
        font.setFamily("Malgun Gothic")
        font.setPointSize(9)
        self.C3rd_Lbl.setFont(font)
        # self.C3rd_Lbl.setStyleSheet("")
        self.C3rd_Lbl.setObjectName("C3rd_Lbl")

        self.C4th = QtWidgets.QPushButton(Client)
        self.C4th.setGeometry(QtCore.QRect(310, 350, 70, 20))
        font = QtGui.QFont()
        font.setFamily("Malgun Gothic")
        font.setPointSize(9)
        self.C4th.setFont(font)
        # self.C4th.setStyleSheet("")
        self.C4th.setObjectName("C4th")
        self.C4th_Lbl = QtWidgets.QLabel(Client)
        self.C4th_Lbl.setGeometry(QtCore.QRect(380, 350, 20, 20))
        font = QtGui.QFont()
        font.setFamily("Malgun Gothic")
        font.setPointSize(9)
        self.C4th_Lbl.setFont(font)
        # self.C4th_Lbl.setStyleSheet("")
        self.C4th_Lbl.setObjectName("C4th_Lbl")
        # ----- Experimental UI ----- #
...
"")
    ...
    def retranslateUi(self, Client):
        ...
        # ----- Experimental UI ----- #
        self.C1st.setText(_translate("Client", "none"))
        self.C1st_Lbl.setText(_translate("Client", "1"))

        self.C2nd.setText(_translate("Client", "none"))
        self.C2nd_Lbl.setText(_translate("Client", "2"))

        self.C3rd.setText(_translate("Client", "none"))
        self.C3rd_Lbl.setText(_translate("Client", "3"))

        self.C4th.setText(_translate("Client", "none"))
        self.C4th_Lbl.setText(_translate("Client", "4"))
        # ----- Experimental UI ----- #
